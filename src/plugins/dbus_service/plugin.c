...
static gboolean __lambda0_ (UsageController* self);
...
static gint __lambda2_ (Block3Data* _data3_, gconstpointer a, gconstpointer b);
...
static void usage_controller_initLowlevel (UsageController* self) {
	...
	if (_tmp6_ == ((0 != _tmp5_label0) ? _tmp5_label0 : (_tmp5_label0 = g_quark_from_static_string ("android")))) {
	...
	} else if (_tmp6_ == ((0 != _tmp5_label4) ? _tmp5_label4 : (_tmp5_label4 = g_quark_from_static_string ("palmpre")))) {
		switch (0) {
			default:
			{
				gchar* _tmp11_;
				_tmp11_ = g_strdup ("LowLevelPalmPre");
				_g_free0 (typename);
				typename = _tmp11_;
				break;
			}
		...
		switch (0) {
			default:
			{
				...
				gchar* _tmp15_ = NULL;
				gchar* _tmp16_;
				FsoUsageNullLowLevel* _tmp17_;
				_tmp12_ = ((FsoFrameworkAbstractObject*) self)->logger;
				_tmp13_ = lowleveltype;
				_tmp14_ = string_to_string (_tmp13_);
				_tmp15_ = g_strconcat ("Invalid lowlevel_type ", _tmp14_, "; suspend/resume will NOT be available!", NULL);
				_tmp16_ = _tmp15_;
				fso_framework_logger_warning (_tmp12_, _tmp16_);
				_g_free0 (_tmp16_);
				_tmp17_ = fso_usage_null_low_level_new ();
				_g_object_unref0 (self->priv->lowlevel);
				self->priv->lowlevel = (FsoUsageLowLevel*) _tmp17_;
				_g_free0 (typename);
	...
	if (g_strcmp0 (_tmp18_, "none") != 0) {
		...
		if (_tmp21_ == G_TYPE_INVALID) {
			...
			gchar* _tmp25_ = NULL;
			gchar* _tmp26_;
			FsoUsageNullLowLevel* _tmp27_;
			_tmp22_ = ((FsoFrameworkAbstractObject*) self)->logger;
			_tmp23_ = lowleveltype;
			_tmp24_ = string_to_string (_tmp23_);
			_tmp25_ = g_strconcat ("Can't find plugin for lowlevel_type ", _tmp24_, "; suspend/resume will NOT be available!", NULL);
			_tmp26_ = _tmp25_;
			fso_framework_logger_warning (_tmp22_, _tmp26_);
			_g_free0 (_tmp26_);
			_tmp27_ = fso_usage_null_low_level_new ();
			_g_object_unref0 (self->priv->lowlevel);
			self->priv->lowlevel = (FsoUsageLowLevel*) _tmp27_;
			_g_free0 (typename);
			_g_free0 (lowleveltype);
			return;
		}
		...
		_g_object_unref0 (self->priv->lowlevel);
		self->priv->lowlevel = FSO_USAGE_IS_LOW_LEVEL (_tmp30_) ? ((FsoUsageLowLevel*) _tmp30_) : NULL;
		_tmp31_ = ((FsoFrameworkAbstractObject*) self)->logger;
		_tmp32_ = lowleveltype;
		_tmp33_ = string_to_string (_tmp32_);
		_tmp34_ = g_strconcat ("Ready. Using lowlevel plugin ", _tmp33_, " to handle suspend/resume", NULL);
		_tmp35_ = _tmp34_;
...
static UsageResource** usage_controller_retrievePriorizedResourceList (UsageController* self, gboolean revertOrder, int* result_length1) {
	...
	gee_array_list_sort_with_data (_tmp26_, ___lambda2__gcompare_data_func, _data3_);
